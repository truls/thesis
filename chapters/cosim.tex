...
As an example, we revisit our trivial PlusOne example introduced in
\Cref{sec:smeilex}, this time implementing one half of it in Python seen in
...
\Cref{fig:oktype} was actually simulated, the resulting code shown in
